public class Exercise9 {
  public static void main(String[] args) {
    ...
    System.out.println(String.format("%s %11d%% %6d%% %6d%% %7.2f%%", "323144324", 67, 70, 78, 71.67));
    System.out.println(String.format("%s %11d%% %6d%% %6d%% %7.2f%%", "324435007", 89, 73, 86, 82.67));
    System.out.println(String.format("%s %11d%% %6d%% %6d%% %7.2f%%", "375842516", 67, 64, 58, 63.00));
    System.out.println(String.format("%s %11d%% %6d%% %6d%% %7.2f%%", "300644535", 95, 67, 75, 79.00));
    
    System.out.println("-----------------------------------------------");
    System.out.println(String.format("%40s %4.2f%%", "Class average", 74.08));
  }
}